...
```bash
curl -L -o Fast https://raw.githubusercontent.com/NVainer/OS_Ready/main/ubuntu_to_kali/ubuntu_kali.sh && chmod +x ./Fast && ./Fast
```
OR

```bash
wget -O Fast https://raw.githubusercontent.com/NVainer/OS_Ready/main/ubuntu_to_kali/ubuntu_kali.sh && chmod +x ./Fast && ./Fast
```
