...
function Write-EnvironmentReport {
    ...
    try {
        $d = Get-CimInstance Win32_LogicalDisk -Filter "DeviceID='C:'" -Verbose:$false -ErrorAction Stop
...
Invoke-Step "17. Clean desktop & remove bloat"   { Remove-DesktopShortcuts } -Mutating
...
Invoke-Step "18. Install + activate Office" { Install-Office } -Mutating
