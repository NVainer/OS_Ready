...
#   ./ubuntu.sh --help
#
# Sections: essentials cli fonts dev security autoupdates pro brave gnome theme
#           hebrew zsh ssh
#
...
SECTIONS=(essentials cli fonts dev security autoupdates pro brave gnome theme hebrew zsh ssh)
