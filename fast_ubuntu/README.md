...
```bash
curl -L -o Fast https://raw.githubusercontent.com/NVainer/OS_Ready/main/fast_ubuntu/ubuntu.sh && chmod +x ./Fast && ./Fast
```
OR

```bash
wget -O Fast https://raw.githubusercontent.com/NVainer/OS_Ready/main/fast_ubuntu/ubuntu.sh && chmod +x ./Fast && ./Fast
```
